...
import { formFieldSchema, FormFieldSchemaType } from "../schemas/form"

export function EditFieldDialog({ children, defaultValues, updateField }: {
  ...
  return (
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent>
        ...
        <EditFieldForm onClose={() => setOpen(false)} updateField={updateField} defaultValues={defaultValues} />
      </DialogContent>
    </Dialog>
  )
}
...
function EditFieldForm({ defaultValues: dv, updateField, onClose }: {
  defaultValues: FormField, updateField: (fieldId: string,
    updates: Partial<FormField>) => void,
  onClose: () => void;
